...
const TRANSLATIONS = {
    it: {
        ...
        ui: {
            ...
            footer_info: "👋 Info? Suggerimenti? Collaborazioni? Demo? Restiamo in contatto!",
    ...
    en: {
        ...
        ui: {
            ...
            footer_info: "👋 Info? Suggestions? Collabs? Demo? Let's stay in touch!",
    ...
    fr: {
        ...
        ui: {
            ...
            footer_info: "👋 Info? Suggestions? Collabs ? Démo ? Restons en contact !",
        ...
        <div id="view-game" class="w-full max-w-7xl p-2 md:p-6 fade-in h-screen flex flex-col relative">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 flex-grow overflow-hidden">
                ...
                <div class="lg:col-span-3 flex flex-col gap-2 overflow-y-auto">
                    ...
                    <div class="vietri-card p-4 bg-white border-yellow-400 text-center relative flex-grow overflow-y-auto">
